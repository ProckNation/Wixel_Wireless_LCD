...
Changelog:
* 2.1 / 12-7-2014:
  Changing code to allow library to work with the Wixel when setup as
  a serial to i2c bridge.  This will allow me to send serial commands
  from one wixel set up as Serial only bridging from UART to radio to 
  another Wixel setup as Serial to i2c with Serial from the radio and 
  I2C out the SCL(default: P1_0) and SDA(default: P1_1) pins on the 
  Wixel's PCB.  There will be more information at the ProckNation Public
  Wiki at http://thewiki.procknation.com/index.php?title=Wixel_Wireless_LCD
  and at Github at https://github.com/ProckNation/Wixel_Wireless_LCD.  
  You can follow along at the github site since the project is public, 
  but I will not have any info at the ProckNation Wiki until I have 
  finished the first working device with working code.
* 1.5.1 / 8-7-2013:
